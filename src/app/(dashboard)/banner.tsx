...
export const Banner = () => {
  ...
  return (
    <div className="text-white aspect-[5/1] min-h-[248px] flex gap-x-6 p-6 items-center
    rounded-xl bg-gradient-to-r from-[#2e62cb] via-[#0073ff] to-[#3faff5]">
      ...
      <div className="flex flex-col gap-y-2">
        ...
        <Button variant="secondary" className="w-[160px]" onClick={onClick} disabled={mutation.isPending}>
          Start creating
